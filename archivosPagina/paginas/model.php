...
class Model{
    ...
    var $id_user; // id del usuario que aporta la informacion
    var $tupla_aceptada; // tupla validada por el admin
    ...
    function Aporte(){
        ...
        $stmt->bindValue(":par0",$this->tupla_aceptada); //tupla valida
        ...
        $stmt->bindValue(":paruser",$this->id_user); // agrega quien es la fuente del hongo agregado

       
        if($stmt->execute()){
            echo "<h1> Insertadas correctamente</h1>";
        }else{
    ...
    function Aporte_csv(){
        ...
        while(($dato=fgetcsv($archivo,1000,",","\n"))!= FALSE){
            ...
            */
            //echo $dato[13] . "<br />\n";
            //echo $dato[14] . "<br />\n";
            if($numero == 16){//cantidad de parametros
                $sql = "INSERT INTO Hongos VALUES (:par0, :par1,:par2,:par3,:par4,:par5,:par6,:par7,:par8,:par9,:par10,:par11,:par12,:par13,:par14,:par15,:par16,:par17,:par18,:par19,:par20,:paruser)";
                ...
                if($stmt->execute()){
                    ...
                    echo "<p>Incorrecto: No insertado</p>";
                    echo "\nPDO::errorCode(): ", $stmt->errorCode();
                ...
                echo "<p>Incorrecto: No insertado por qué no aporto la cantidad de parametros necesarios</p>";
        ...
        echo "<h1>Tuplas insertadas correctamente: $fila</h1>";
