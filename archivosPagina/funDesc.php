<?php
    function descCsv(){
        ...
        $data = "id_hongo,nomb_cient,nomb_vulgar,familia,habitat,color,id_area_consv,ubicacion,habito,temporada,clasificacion,pileo,himenoforo,estipite,fecha_avista,altura_avisto,observacion,img_sup,img_inf,img_lat,img_mano_hongo,usuario_fuente \n";
        ...
        while ($row = sqlsrv_fetch_array($qry, SQLSRV_FETCH_ASSOC)) {
            $data .= $row['id_hongo'] . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['nomb_cient']) . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['nomb_vulgar']) . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['familia']) . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['habitat']) . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['color']) .
                ...
                $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['himenoforo']) . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['estipite']) . $csv_sep . $row['fecha_avista']->format('Y-m-d H:i:s') . $csv_sep . $row['altura_avisto'] . $csv_sep . str_replace(array("\n","\r\n","\r",",",";",".")," ",$row['observacion']) . $csv_sep . $row['img_sup'] .
